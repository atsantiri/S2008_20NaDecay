...
void vDriftfromAlpha()
{
    ...
    auto hLast =
        dfXY.Histo2D({"hLast", "LastPoint XY;X [pads];Y [pads]", 1000, -100, 150, 1000, -100, 150}, "fLastX", "fLastY");
    auto hOther = dfXY.Histo2D({"hOther", "OtherPoint XY;X [pads];Y [pads]", 1000, -100, 150, 1000, -100, 150},
                               "fOtherX", "fOtherY");
